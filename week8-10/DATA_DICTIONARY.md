...
in `week8-10/market_analysis.twbx` because neither is required by a visualization.
...
`week8-10/competitive_analysis.twbx`; its embedded extract excludes `EventId` and
